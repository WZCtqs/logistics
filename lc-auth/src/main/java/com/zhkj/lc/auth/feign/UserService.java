...
package com.zhkj.lc.auth.feign;

import com.zhkj.lc.auth.feign.fallback.UserServiceFallbackImpl;
...
/**
 * @author cb
 * @description feign调用用户数据
 */
@FeignClient(name = "lc-upms-service", fallback = UserServiceFallbackImpl.class)
