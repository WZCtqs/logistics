 ...
 */
@Data
@ApiModel(description = "正常油卡充值实体类")
@TableName("oil_recharge")
public class RechargeNormal extends Model<RechargeNormal> {
	 ...
	 * 充值状态（充值时间不为空：充值成功）
	 */
    @ApiModelProperty(value = "充值状态（充值时间不为空：充值成功）",readOnly = true)
	@Excel(name="充值状态")
	private String isRechargeed;
	/**
	 * 充值时间
	 */
    @ApiModelProperty(value = "充值时间",example = "2018-12-12",readOnly = true)
	@Excel(name="充值时间")
