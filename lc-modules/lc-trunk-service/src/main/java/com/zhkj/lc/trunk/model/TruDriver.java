...
public class TruDriver extends Model<TruDriver> {
    ...
    @TableField(exist = false)
    private List<TruTruck> truTrucks;*/

   /* public List<TruTruck> getTruTrucks() {
        return truTrucks;
    }

    public void setTruTrucks(List<TruTruck> truTrucks) {
        this.truTrucks = truTrucks;
    }*/

    /**
     * 司机常跑路线数组
     */
    @ApiModelProperty(value = "司机常跑路线list表")
    @TableField(exist = false)
    private FreightRoute[] freightRoute;
    /**
     * 司机常跑路线list
     */
    @ApiModelProperty(value = "司机常跑路线list表")
    @TableField(exist = false)
    private List<FreightRoute> freightRouteList;
    /**
     * 开始时间区间
     */
    ...
    public String toString() {
        return "TruDriver{" +
                ...
                ", idcardPhotoUp='" + idcardPhotoUp + '\'' +
                ", idcardPhotoUpArr=" + Arrays.toString(idcardPhotoUpArr) +
                ", idcardPhotoDown='" + idcardPhotoDown + '\'' +
                ", idcardPhotoDownArr=" + Arrays.toString(idcardPhotoDownArr) +
                ", phone='" + phone + '\'' +
                ", urgentPhone='" + urgentPhone + '\'' +
                ", licenseLevel='" + licenseLevel + '\'' +
                ", driveYears=" + driveYears +
                ", licensePhoto='" + licensePhoto + '\'' +
                ", licensePhotoArr=" + Arrays.toString(licensePhotoArr) +
                ", qualification='" + qualification + '\'' +
                ", qualificationArr=" + Arrays.toString(qualificationArr) +
                ", licenseLevelTime=" + licenseLevelTime +
                ", licenseLevelStatus='" + licenseLevelStatus + '\'' +
                ...
                ", xopenId='" + xopenId + '\'' +
                ", gopenId='" + gopenId + '\'' +
                ", driverIds=" + Arrays.toString(driverIds) +
                ", truTruck=" + truTruck +
                ", freightRoute=" + Arrays.toString(freightRoute) +
                ", freightRouteList=" + freightRouteList +
                ", beginTime=" + beginTime +
                ", endTime=" + endTime +
                ", freightOilcardAmount=" + freightOilcardAmount +
                '}';
    }
}
