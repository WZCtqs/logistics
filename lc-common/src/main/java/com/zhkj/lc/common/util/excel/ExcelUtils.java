...
import com.zhkj.lc.common.util.SheetData;
...
public class ExcelUtils {
    ...
    /**
     * 写入excel数据
     * @param model 采用的模板 位置在 resources/static/excel/下 模板第一个sheet页必须是模板sheet
     * @param sheetDatas 模板数据
     */
    public static AjaxResult writeData(String model , SheetData... sheetDatas ) {
        OutputStream out = null;
        Workbook wb = null;
        try {
            InputStream input = ExcelUtils.class.getResourceAsStream("/static/excel/" + model);
            ...
            String downloadPath = Global.getDownloadPath() + sheetDatas[0].getName()+".xlsx";
            ...
            wb.close();
            out.close();
            return AjaxResult.success(sheetDatas[0].getName()+".xlsx");
        } catch (IOException e) {
