package com.zhkj.lc.common.util.excel;
...
public class ExcelUtil<T>
{
     ...
     * @return 结果
     */
    public AjaxResult exportExcel(HttpServletResponse response, List<T> list, String sheetName, String[] hiddenArray)
    {
...
//                        cellStyle.setFillForegroundColor(HSSFColor.HSSFColorPredefined.LIGHT_ORANGE.getIndex());
                        ...
                        if(checkExit(hiddenArray,attr.name())){
                        ...
                        try
                        {
                            ...
                            if (attr.isExport())
                            {
                                ...
                                catch (Exception e)
                                {
                                    ...
                                    {
                                        if(String.valueOf(field.get(vo)).length()==28){
                                            try{
                                                Date date = new Date(String.valueOf(field.get(vo)));
    ...
    public AjaxResult exportExcel(HttpServletRequest request, HttpServletResponse response, List<T> list, String sheetName, String[] hiddenArray)
    {
        OutputStream out = null;
        HSSFWorkbook workbook = null;
        try
...
//                        cellStyle.setFillForegroundColor(HSSFColor.HSSFColorPredefined.LIGHT_ORANGE.getIndex());
     ...
     */
    public static boolean checkExit(String[] checkArray,String column){
        if(null!= checkArray && checkArray.length>0){
            return Arrays.toString(checkArray).contains(column);
        }else {
            return false;
        }
    }
